...
END_OF_SENDING_INDIRECT_MESSAGE:
        ...
        {
            P2PStatus.bits.RxHasUserData = 1;
			miwimsgbuf[0] = MACRxPacket.Payload[0];
			bar = MWQueue_sendmsg(1,mtype,(void *)miwimsgbuf);
			ToMainHigh_sendmsg(1, MSGT_MIWI_DATA, (void*)miwimsgbuf);
			//bar = MWQueue_sendmsg(1,&mtype,(void *)0x91);
			bar = 0;
