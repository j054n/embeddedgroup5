...
//Queue:
//From the timer queue to the main()
signed char ADQueue_sendmsg(unsigned char,unsigned char,void *);
signed char ADQueue_recvmsg(unsigned char,unsigned char *,void *);
#endif
