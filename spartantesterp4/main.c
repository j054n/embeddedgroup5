...
#pragma config WDT = OFF
	...
	//set up test vectors
	rom unsigned char ad11[32] = {0x00,0x00,0x00,0x03,0x00,0x03,0x01,0x01,0x00,0x03,0x03,0x03,
								0x03,0x03,0x03,0x03,0x03,0x03,0x00,0x03,0x01,0x03,0x02,0x02,
								0x03,0x03,0x03,0x00,0x00,0x00,0x00,0x00};
	rom unsigned char ad12[32] = {0x00,0x00,0x00,0xFF,0x00,0xFF,0xFF,0xFF,0x00,0xFF,0xFF,0xFF,
								0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0xFF,0x32,0xCE,0xF6,
								0x14,0x28,0x34,0x00,0x00,0x00,0x00,0x00};
	rom unsigned char ad21[32] = {0x00,0x00,0x00,0x03,0x03,0x00,0x01,0x01,0x00,0x03,0x03,0x03,
								0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x00,0x01,0x03,0x02,0x02,
								0x03,0x03,0x03,0x00,0x00,0x00,0x00,0x00};
	rom unsigned char ad22[32] = {0x00,0x00,0x00,0xFF,0xFF,0x00,0xFF,0xFF,0x00,0xFF,0xFF,0xFF,
								0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0x32,0xCE,0xF6,
								0x14,0x28,0x34,0x00,0x00,0x00,0x00,0x00};
	rom unsigned char user[32] = {0,0,0,0,0,0,0,0,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3};
	rom unsigned char expected[32] = {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xE1,0xC3,0xA5,
										0x87,0x69,0x4B,0x2D,0x0F,0x00,0x1E,0x3C,0x5A,0x5A,0x6E,0x78,
										0x7D,0x7F,0x7F,0x9D,0xBB,0xD9,0xF7,0xFF};
						...
						case 0x51: //extended message
							switch (msgbuffer[9]) //Cmd1 byte
							{
								case 0x11: //Insteon command: On
									LATBbits.LATB5 = 1;
									break;
								case 0x13: //Insteonbn command: off
									LATBbits.LATB5 = 0;
									break;
								case 0x19: //Status Request
									msgbuffer[0] = 0x02;
									msgbuffer[1] = 0x68; // Set Insteon ACK
									if(LATBbits.LATB5) // if LED is on
									{
										msgbuffer[2] = 0xFF; // On-level
									}
									else
									{
										msgbuffer[2] = 0x00;
