...
void readADCChan(unsigned char channel) //function reads from the ADC and returns a value 0x0 to 0x03FF
{
	unsigned char buffer[2];
	int value;
	OpenADC(ADC_FOSC_16 & ADC_RIGHT_JUST & ADC_0_TAD,
		ADC_CH10 &  ADC_CH9&ADC_CH8&ADC_CH7&ADC_CH6&ADC_CH5&ADC_CH4&ADC_CH3&ADC_CH1&ADC_CH1&
...
void readADC() //function reads from the ADC and returns a value 0x0 to 0x03FF
{
	...
	LATB=ADQueue_sendmsg(2,mtype,(void *)buffer);
}